# microsoft.com API - Version cognitiveservices-LocalSearch
...
- **Version**: cognitiveservices-LocalSearch
- **File**: swagger.yaml
- **Original Path**: microsoft.com/cognitiveservices-LocalSearch/1.0/swagger.yaml
